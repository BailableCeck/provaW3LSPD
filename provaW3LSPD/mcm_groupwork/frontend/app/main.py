...
class QueryForm(FlaskForm):
    ...
    piscina_checkbox = BooleanField('Piscina')
    accesso_disabili_checkbox = BooleanField('Accesso Disabili')
    fitness_checkbox = BooleanField('Fitness')
    sauna_checkbox = BooleanField('Sauna Checkbox')
    aria_condizionata_checkbox = BooleanField('Aria Condizionata')
    animali_amessi_checkbox = BooleanField('Animali Ammessi')
